...
from exp.exp_long_term_forecasting_TSAR import Exp_Long_Term_Forecast_TSAR
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task_name', type=str, required=False, default='long_term_forecast_TSAR',
                        help='task name, options:[long_term_forecast, short_term_forecast, imputation, classification, anomaly_detection]')
    parser.add_argument('--is_training', type=int, required=False, default=0, help='status')
    parser.add_argument('--model_id', type=str, required=False, default='test', help='model id')
    parser.add_argument('--model', type=str, required=False, default='TSAR',
    ...
    parser.add_argument('--transfer_root_path', type=str, default='./data/ETT-small/',
    ...
    parser.add_argument('--lambda_48', type=float, default=0.2, help='loss weight for minimum scale')
    ...
    if args.task_name == 'long_term_forecast':
        ...
        Exp = Exp_Long_Term_Forecast_TSAR
